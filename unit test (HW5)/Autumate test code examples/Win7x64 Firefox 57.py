...
class BasicTest(unittest.TestCase):
    def setUp(self):
        ...
        self.username = "gaving@bu.edu"
        self.authkey  = "u5222955dff92496"
        ...
        caps['name'] = 'Jinguang Guo resume website'
        caps['build'] = '1.0'
    ...
    def test_CBT(self):
        ...
        try:
            # load the page url
            print('Loading Url')
            self.driver.get('https://ec601-hw2-f7238.firebaseapp.com/')
            ...
            self.assertEqual("Jinguang Guo - Computer Engineering", self.driver.title)
